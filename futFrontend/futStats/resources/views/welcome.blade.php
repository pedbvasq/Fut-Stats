                ...
                <div class="container">
                    <div class="hero-inner">
						...
						<div class="hero-figure anime-element">
                            <img src="{{ asset('/assets/images/landing.png') }}"width="528" height="396"> 
						</div>
                    </div>
                </div>
            </section>
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">FutStat lo tiene todo!</h2>
						<div class="pricing-tables-wrap">
                            <div class="pricing-table">
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
										<div class="pricing-table-features-title text-xs pt-24 pb-24">Ofrecemos:</div>
                                        <ul class="pricing-table-features list-reset text-xs">
                                            <li>
                                                <span>Datos mas reelevantes de jugadores</span>
                                            </li>
                                            <li>
                                                <span>Informacion sobre las mejores ligas</span>
                                            </li>
                                            <li>
                                                <span>Datos actualizados de los mas grandes equipos</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
